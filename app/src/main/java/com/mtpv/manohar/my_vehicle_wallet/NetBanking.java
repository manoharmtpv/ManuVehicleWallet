...
public class NetBanking extends Activity implements LocationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		System.out.println("Public_Acitivity.regNoFLG: "+Pendingchallansbyregno.regNoFLG);
		System.out.println("Public_Acitivity.dlFLG: "+Pendingchallansbyregno.dlFLG);
		System.out.println("Public_Acitivity.aadhaarFLG: "+Pendingchallansbyregno.aadhaarFLG);
				...
				public void run() {
					...
					try {
						...
						webview.setWebViewClient(new WebViewClient());
						 webview.postUrl("https://125.16.1.70:8080/publicviewT/MobileRequestProcessor.do", EncodingUtils.getBytes(postData, "utf-8"));
