...
public class Fitness extends Fragment {
            ...
            public void onClick(View v) {
...

                {
                    if (isOnline()) {
                        ...
                        UploadFitnessDetails uploadFitnessDetasils = new UploadFitnessDetails();
                        uploadFitnessDetasils.execute();
    ...
    public class UploadFitnessDetails extends AsyncTask<String, Void, String> {

        ProgressDialog dialog;

        protected void onPreExecute() {
            dialog = new ProgressDialog(getActivity());
            dialog.setTitle("Uploading Fitness Details");
        ...
        protected String doInBackground(String... params) {
            ...
            String response = ServiceHelper.FitnessDetailsUpload(regno.toUpperCase(), "NA", issueauth.toUpperCase(), validupto.toUpperCase(), remarks.toUpperCase(), imgString, "NA", Vehicle_Wallet_Login.Mobilenum, Vehicle_Wallet_Login.usertype.toUpperCase());
