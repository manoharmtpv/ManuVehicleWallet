...
public class Permit extends Fragment {
            ...
            public void onClick(View v) {
...

                {
                    if (isOnline()) {
                        ...
                        UploadPermitDetails uploadPermitDetasils = new UploadPermitDetails();
                        uploadPermitDetasils.execute();
    ...
    public class UploadPermitDetails extends AsyncTask<String, Void, String> {

        ProgressDialog dialog;

        protected void onPreExecute() {
            dialog = new ProgressDialog(getActivity());
            dialog.setTitle("Uploading Permit Details");
        ...
        protected String doInBackground(String... params) {
            ...
            String response = ServiceHelper.PermitDetailsUpload(regno.toUpperCase(), "NA", issueauth.toUpperCase(), validupto.toUpperCase(), remarks.toUpperCase(), imgString, "NA", Vehicle_Wallet_Login.Mobilenum, Vehicle_Wallet_Login.usertype.toUpperCase());
