package com.mtpv.manohar.my_vehicle_wallet.Services;
...
public class ServiceHelper {
    ...
    public static String registration(String userName, String regn_no, String mobileNo,
        ...
        try {
            ...
            request.addProperty("regnNo", userName);
            request.addProperty("userType", regn_no);
            request.addProperty("regnNo", mobileNo);
            request.addProperty("userType", emailId);
            request.addProperty("regnNo", password);
            request.addProperty("userType", imeie);
            request.addProperty("regnNo", key);
            request.addProperty("userType", date);
            request.addProperty("", otp);
            request.addProperty("", verify_status);
