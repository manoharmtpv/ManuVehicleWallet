...
public class Insurance extends Fragment {
    ...
    Uri imageUri;
    EditText et_vehicleNo,et_insuranceno,et_insurancename,et_remarks;
    View rootView;
    String regno=null,insNo=null,insCmpnyname=null,remarks=null,imgString,validupto=null;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        et_insuranceno=(EditText)rootView.findViewById(R.id.et_insuranceno);
        et_insurancename=(EditText)rootView.findViewById(R.id.et_insurancename);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else  if(et_insuranceno.getText().toString().trim().equals(""))
                {
                    showtoast("Validation","Please fill the Insurance No.  to continue");
                    et_insuranceno.requestFocus();
                }
                else  if(et_insurancename.getText().toString().trim().equals(""))
                {
                    showtoast("Validation","Please fill the Insurance Name.  to continue");
                    et_insurancename.requestFocus();
                }
...

                {
                            ...
                            if (isOnline()) {
                                try {
                                    ...
                                    insCmpnyname = et_insurancename.getText().toString();
                                ...
                                final Uploainsurancedetails uploainsurancedetails=new Uploainsurancedetails();
                                uploainsurancedetails.execute();
                                ...
                                handler.postDelayed(new Runnable()
                                {
                                    @Override
                                    public void run() {
                                        if ( uploainsurancedetails.getStatus() == AsyncTask.Status.RUNNING )
                                            uploainsurancedetails.cancel(true);

                                        showtoast("Validation","Server Busy Please try sometime later");
                                    }
                                }, 30000);
  ...
  @SuppressWarnings("deprecation")
    ...
    public class Uploainsurancedetails extends AsyncTask<String, Void, String> {

        ProgressDialog dialog;

        protected void onPreExecute() {
            dialog = new ProgressDialog(getActivity());
            dialog.setTitle("Uploading Insurance Details");
        ...
        protected String doInBackground(String... params) {
            ...
            String response = ServiceHelper.InsuanceDetailsUpload(regno.toUpperCase(),insNo.toUpperCase(),insCmpnyname.toUpperCase(),validupto.toUpperCase(),remarks.toUpperCase(),imgString,"NA",Vehicle_Wallet_Login.Mobilenum,Vehicle_Wallet_Login.usertype.toUpperCase());
