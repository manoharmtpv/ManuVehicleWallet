...
public class Pendingchallansbyregno extends Fragment {
...
//		title1 = (TextView)findViewById(R.id.title2);
        ...
        vehicle_heading.setText("Vehicle Details");
        heading.setText("Enter Vehicle Number");
        vehicle_no.setHint("Enter Vehicle Number");
        vehicleNo_text.setText("Vehicle No");
        vehicle_no.setText("");
                ...
                if (!vehicle_no.getText().toString().equals("")) {
                    if (captcha_text.getText().toString().trim().equals("")) {
                        ...
                        if (captcha_text.getText().toString().equals(""+captcha_received) && "Y".equals(Verify_Status)) {
                            ...
                            Async_task_regno async_task_regno=new Async_task_regno();
                            async_task_regno.execute();
    ...
    public class Async_task_regno extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            ServiceHelper.GetViolationByRegnNo(getRegNo,Vehicle_Wallet_Login.usertype,captcha_received,Vehicle_Wallet_Login.Mobilenum);
            return null;
        }
        ...
        protected void onPostExecute(String result) {
            ...
            if (ServiceHelper.Opdata_Chalana.equals("1")){
                showtoast("Validation","Invalid Captcha");
                captcha_text.setText("");
                table_layout.removeAllViews();
                scroll.setVisibility(View.GONE);
                ...
                table_layout.removeAllViews();
                scroll.setVisibility(View.GONE);
            }else if (ServiceHelper.Opdata_Chalana.length()>4){
                ...
                String strJson = ServiceHelper.Opdata_Chalana;
                try {
                        ...
                        for (int j = 1; j <= 4; j++) {
                            if (j == 1) {
                                ...
                                if(violat_amt.contains("|")){
                                    ...
                                    totamt=Integer.parseInt(cmd_fin_amt);
                                }
